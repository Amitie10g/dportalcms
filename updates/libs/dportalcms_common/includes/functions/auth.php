 ...
 * Return values:
 *
 *	If Username and Password matchs against the data stored,
 *	this function will return TRUE. Elsewhere, will return BOOLEAN.
 *
 */
...
function ini_login($get_user,$get_pass){
    ...
    if(sha1($get_user) == $admin_user && sha1($get_pass) == $admin_password) return true;
		else return false;
}
