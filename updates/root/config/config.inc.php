...
$sitename	= "DPortal CMS Project developement site";
$sitedesc	= "CMS without Database Engine, easy to install and manage, and with Memcached support.";
...
$cse_key = "003226150392065759631:sxb9vcz6utq";
$memcached_server = "";
$memcached_port = "";
