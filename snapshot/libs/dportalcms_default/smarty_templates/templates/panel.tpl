...
{{if $MODE != 'create'}}<a href="{{LINK script="panel" section="gallery/create"}}">{{/if}}Create Gallery{{if $MODE != 'create'}}</a>{{/if}}

{{elseif $TAB == "videos"}}
{{if $MODE != 'upload'}}<a href="{{LINK script="panel" section="videos/upload"}}">{{/if}}Upload videos{{if $MODE != 'upload'}}</a>{{/if}} | 
{{if $MODE != 'edit'}}<a href="{{LINK script="panel" section="videos/edit"}}">{{/if}}Edit Playlist{{if $MODE != 'edit'}}</a>{{/if}} | 
