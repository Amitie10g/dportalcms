...
<p>The following folders should be <strong>writable</strong> in order ti onstall DPortal CMS:</p>
<ul>
	<li>/config</li>
	<li>/content</li>
	<li>/comments</li>
...
<p>Please review if above folders have the proper permissions to write, in order to create the files for content.</p>
