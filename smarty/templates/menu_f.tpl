	...
	{{* All Categories *}}
	<a class="dock-item2" href="{{LINK script="categories"}}"><span>{{$LANG.all_categories|ucfirst}}</span><img src="{{$smarty.const.DPORTAL_PATH}}/css-dock-menu/images/categories.png" alt="{{$LANG.all_categories|ucfirst}}" /></a>
	</div>
</div>
