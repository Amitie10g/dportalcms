	...
	getEditorTemplate : function(settings, editorId) {
		...
		switch(layoutManager) {
			case "SimpleLayout" : //the default TinyMCE Layout (for backwards compatibility)...
				...
				var defVals = {
					theme_advanced_buttons1 : "close,save,newdocument,separator,undo,redo,separator,fontsizeselect,bold,italic,underline,forecolor,removeformat,separator,justifyleft,justifycenter,justifyright,separator,bullist,numlist,separator,link,unlink,anchor,separator,hr,image,table,separator,preview,code,fullscreen,cleanup,separator,help"
				};
