	...
	getControlHTML : function(button_name) {
		...
		switch (button_name) {
			case "formatselect":
				...
				var formats = tinyMCE.getParam("theme_advanced_blockformats", "p,address,line,pre,h1,h2,h3,h4,h5,h6,line,blockquote,samp", true).split(',');
				var lookup = [
	...
	getEditorTemplate : function(settings, editorId) {
		...
		switch(layoutManager) {
			case "SimpleLayout" : //the default TinyMCE Layout (for backwards compatibility)...
				...
				var defVals = {
					theme_advanced_buttons1 : "close,save,newdocument,separator,preview,code,cleanup,separator,undo,redo,separator,fontsizeselect,bold,italic,underline,forecolor,removeformat,separator,justifyleft,justifycenter,justifyright,separator,bullist,numlist,separator,link,unlink,anchor,separator,hr,image,table,separator,fullscreen,help"
				};
