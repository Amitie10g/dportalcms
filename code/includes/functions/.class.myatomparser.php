  ...
  class myAtomParser
  {
    ...
    function display_feed($data, $limit)
    {
      ...
      if($TITLE) {
        ...
        $this->retval .= "<li onclick=\"items(1)\">";     
        /*if($LINK)*/ $this->retval .= "<div style=\"text-align:center\"><a href=\"#feed\" style=\"font-weight:bold;text-decoration:underline\" title=\"Mostrar/ocultar Feed\">";
        $this->retval .= stripslashes($TITLE);
        /*if($LINK)*/ $this->retval .= "</a></div>\n";
        $this->retval .= "<div id=\"item_1\" class=\"contenidoItem\" style=\"font-size:9px\">\n";
    ...
    function display_entry($data, $parent)
    {
      ...
      $this->retval .=  "<p style=\"margin:10px 0 0 0\"><b>";
      if($LINK) $this->retval .=  "<a href=\"$LINK\" rel=\"external\">";
      $this->retval .= stripslashes($TITLE);
