{{* This is an Example Menu. You can cuntomize them. Please see README_MENU for details *}}
<div class="dock2" id="dock2">
  <div class="dock-container2">
		...
		<a class="dock-item2" href="http://code.google.com/p/dportalcms" onclick="window.open('feedback.php','Feedback','width=500,height=500');return false;"><span>Download!</span><img src="{{$smarty.const.DPORTAL_PATH}}/css-dock-menu/images/download.png" alt="Descarga" /></a>
