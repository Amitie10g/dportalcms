...
{{section name='image' loop=$IMAGELIST}}
	<item>
		...
		{{*<enclosure type='image/{{$IMAGELIST[image].ext}}' url='{{LINK section=$IMAGELIST[image].uri script="gallery_image_orig" ext=$IMAGELIST[image].ext}}' title="{{$IMAGELIST[image].desc}}" />*}}
