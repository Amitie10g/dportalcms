<hr />
  ...
  <p style="margin:0;text-align:center">
    ...
    alt="Smarty" title="DPortal is Free Software" />
  </p>

  <p style="margin:0;text-align:center">
    <a href="http://www.smarty.net/" rel="external">
    <img src="{{$smarty.const.DPORTAL_PATH}}/images/smarty_icon.gif" style="border:0;width:88px;height:31px"
    alt="Smarty" title="Powered by Smarty template engine" /></a>
  </p>
