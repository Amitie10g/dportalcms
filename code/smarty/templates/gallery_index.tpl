...
<div style="width:400px;float:center;margin:auto;border:#000000 1px dotted">
	<div style="float:left;padding:5px">
		<a href="{{LINK section=$LIST[list].dirname script="gallery_gallery"}}"><img style="max-width:150px;max-height:100px" src="{{LINK section=$LIST[list].uri script='gallery_image_prev' ext=$LIST[list].ext}}" alt="{{$LIST[list].gallery_title}}" /></a>
	</div>
