...
<div class="dock2" id="dock2">
	<div class="dock-container2">
		...
		{{if $PHPBB_URL_PATH != null}}<a class="dock-item2" href="{{$PHPBB_URL_PATH}}"><span>{{$LANG.forum|ucfirst}}</span><img src="{{$smarty.const.DPORTAL_PATH}}/css-dock-menu/images/forum.png" alt="{{$LANG.forum|ucfirst}}" /></a>{{/if}}
